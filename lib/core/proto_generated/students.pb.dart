...
class SerachStudentResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SerachStudentResult', createEmptyInstance: create)
    ..aOM<Student>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'student', subBuilder: Student.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..hasRequiredFields = false
  ;

  SerachStudentResult._() : super();
  factory SerachStudentResult({
    Student? student,
    $core.String? message,
  }) {
  ...
  factory SerachStudentResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SerachStudentResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SerachStudentResult clone() => SerachStudentResult()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SerachStudentResult copyWith(void Function(SerachStudentResult) updates) => super.copyWith((message) => updates(message as SerachStudentResult)) as SerachStudentResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SerachStudentResult create() => SerachStudentResult._();
  SerachStudentResult createEmptyInstance() => create();
  static $pb.PbList<SerachStudentResult> createRepeated() => $pb.PbList<SerachStudentResult>();
  @$core.pragma('dart2js:noInline')
  static SerachStudentResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SerachStudentResult>(create);
  static SerachStudentResult? _defaultInstance;
...
class Student extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Student', createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dept')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set dept($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class StudentId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudentId', createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class StudentList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudentList', createEmptyInstance: create)
    ..pc<Student>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'student', $pb.PbFieldType.PM, subBuilder: Student.create)
    ..hasRequiredFields = false
  ;
  ...
  factory StudentList.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StudentList.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudentList copyWith(void Function(StudentList) updates) => super.copyWith((message) => updates(message as StudentList)) as StudentList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static StudentList getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StudentList>(create);
