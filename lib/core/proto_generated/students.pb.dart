...
class SearchStudentResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchStudentResult', createEmptyInstance: create)
  ...
  factory SearchStudentResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SearchStudentResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  SearchStudentResult copyWith(void Function(SearchStudentResult) updates) => super.copyWith((message) => updates(message as SearchStudentResult)) as SearchStudentResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SearchStudentResult create() => SearchStudentResult._();
  SearchStudentResult createEmptyInstance() => create();
  static $pb.PbList<SearchStudentResult> createRepeated() => $pb.PbList<SearchStudentResult>();
  @$core.pragma('dart2js:noInline')
  static SearchStudentResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SearchStudentResult>(create);
...
class Student extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Student', createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roomNo', protoName: 'roomNo')
  ...
  @$pb.TagNumber(3)
  $core.String get roomNo => $_getSZ(2);
  @$pb.TagNumber(3)
  set roomNo($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasRoomNo() => $_has(2);
  @$pb.TagNumber(3)
  void clearRoomNo() => clearField(3);
