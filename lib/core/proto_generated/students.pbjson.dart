...
const SearchStudentResult$json = const {
  ...
  '2': const [
    const {'1': 'student', '3': 1, '4': 1, '5': 11, '6': '.Student', '9': 0, '10': 'student', '17': true},
...
final $typed_data.Uint8List searchStudentResultDescriptor = $convert.base64Decode('ChNTZWFyY2hTdHVkZW50UmVzdWx0EicKB3N0dWRlbnQYASABKAsyCC5TdHVkZW50SABSB3N0dWRlbnSIAQESHQoHbWVzc2FnZRgCIAEoCUgBUgdtZXNzYWdliAEBQgoKCF9zdHVkZW50QgoKCF9tZXNzYWdl');
...
const Student$json = const {
  ...
  '2': const [
    ...
    const {'1': 'roomNo', '3': 3, '4': 1, '5': 9, '10': 'roomNo'},
    const {'1': 'gender', '3': 4, '4': 1, '5': 9, '10': 'gender'},
  ],
};

/// Descriptor for `Student`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List studentDescriptor = $convert.base64Decode('CgdTdHVkZW50Eg4KAmlkGAEgASgFUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhYKBnJvb21ObxgDIAEoCVIGcm9vbU5vEhYKBmdlbmRlchgEIAEoCVIGZ2VuZGVy');
...
final $typed_data.Uint8List studentIdDescriptor = $convert.base64Decode('CglTdHVkZW50SWQSDgoCaWQYASABKAVSAmlk');
@$core.Deprecated('Use studentListDescriptor instead')
const StudentList$json = const {
  '1': 'StudentList',
  '2': const [
    const {'1': 'student', '3': 1, '4': 3, '5': 11, '6': '.Student', '10': 'student'},
  ],
};

/// Descriptor for `StudentList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List studentListDescriptor = $convert.base64Decode('CgtTdHVkZW50TGlzdBIiCgdzdHVkZW50GAEgAygLMgguU3R1ZGVudFIHc3R1ZGVudA==');
